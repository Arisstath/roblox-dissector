...
func (thisBitstream *PacketReaderBitstream) DecodeDisconnectionPacket(reader util.PacketReader, layers *PacketLayers) (RakNetPacket, error) {
...
func (layer *DisconnectionPacket) Serialize(writer util.PacketWriter, stream *PacketWriterBitstream) error {
