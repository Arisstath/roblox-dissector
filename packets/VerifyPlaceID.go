...
func (thisBitstream *PacketReaderBitstream) DecodeVerifyPlaceId(reader util.PacketReader, layers *PacketLayers) (RakNetPacket, error) {
...
func (layer *VerifyPlaceId) Serialize(writer util.PacketWriter, stream *PacketWriterBitstream) error {
